...
Godot 4 first-person arena shooter / bullet-hell survival prototype using only primitive meshes and generated UI/effects.
...
- `scripts/game_manager.gd`: run state, pooling, scoring, collision severity, bombs, extra shot
- `scripts/spawn_manager.gd`: spawn pacing, spawn bias, enemy mix
